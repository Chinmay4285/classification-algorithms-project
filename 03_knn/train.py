"""
K-Nearest Neighbors Implementation for Classification
...
from utils.data_utils import load_iris_data, get_gpu_memory_info
...
def train_knn():
    ...
    # Load data
    print("[DATA] Loading Iris dataset (optimal for KNN)...")
    X_train, X_test, y_train, y_test, feature_names = load_iris_data()
    ...
    # Train model
    print("[TRAIN] Training K-Nearest Neighbors model...")
    ...
    # Evaluate
    evaluator = ModelEvaluator("K-Nearest Neighbors")
