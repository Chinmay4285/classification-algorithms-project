...
def train_decision_tree():
    ...
    # Train model
    print("[TRAIN] Training Decision Tree model...")
    ...
    # Evaluate
    evaluator = ModelEvaluator("Decision Tree")
